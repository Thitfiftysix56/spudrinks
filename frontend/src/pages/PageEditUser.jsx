            ...
            >
              <Box sx={{ margin: "10px" }}>
                <Avatar
                  ...
                  src={
                    imageUrl === null
                      ? require(`../../src/ImgPerson/uploads/${data.Image_Person}`)
                      : imageUrl
                  }
                />
              </Box>
              ...
              <Box sx={{ margin: "10px", width: "100%" }}>
                <CssTextField
                  ...
                  label="Username"
                  variant="outlined"
                  defaultValue={data.Username_Person}
              ...
              <Box sx={{ margin: "10px", width: "100%" }}>
                <CssTextField
                  ...
                  variant="outlined"
                  defaultValue={data.NameAccount_Person}
              ...
              <Box sx={{ margin: "10px", width: "100%" }}>
                <CssTextField
                  ...
                  label="ชื่อ"
                  variant="outlined"
                  defaultValue={data.FName_Person}
              ...
              <Box sx={{ margin: "10px", width: "100%" }}>
                <CssTextField
                  ...
                  label="นามสกุล"
                  variant="outlined"
                  defaultValue={data.LName_Person}
              ...
              <Box sx={{ margin: "10px", width: "100%" }}>
                <CssTextField
                  ...
                  type="date"
                  fullWidth
                  defaultValue={data.Birthday_Person}
              ...
              <Box sx={{ margin: "10px", width: "100%" }}>
                <CssTextField
                  ...
                  label="เบอร์โทรศัพท์"
                  variant="outlined"
                  defaultValue={data.Phone_Person}
