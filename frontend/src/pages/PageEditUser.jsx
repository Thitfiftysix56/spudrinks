...
<Box sx={{margin:'10px'}}>
    <Avatar sx={{width:'80px',height:'80px'}}  alt="ไม่มีรูป"   src={imageUrl === null ? require(`../../src/ImgPerson/uploads/${data.Image_Person}`) : imageUrl} />
</Box>
<Box sx={{margin:'10px'}}>
<input
                accept="image/*"
...
<CssTextField id="outlined-basic" fullWidth label="Username" variant="outlined" defaultValue={data.Username_Person} onChange={e => setUserName(e.target.value)}/>
</Box>

<Box sx={{margin:'10px',width:'100%'}}> 
<CssTextField id="outlined-basic" fullWidth label="ชื่อบัญชีผู้ใช้งาน" variant="outlined" defaultValue={data.NameAccount_Person} onChange={e => setNameAccount(e.target.value)}/>
</Box>
<Box sx={{margin:'10px',width:'100%'}}>
<CssTextField id="outlined-basic" fullWidth label="ชื่อ" variant="outlined" defaultValue={data.FName_Person} onChange={e => setFirstName(e.target.value)}/>
</Box>
<Box sx={{margin:'10px',width:'100%'}}>
<CssTextField id="outlined-basic" fullWidth label="นามสกุล" variant="outlined" defaultValue={data.LName_Person} onChange={e => setLastName(e.target.value)}/>
</Box>
<Box sx={{margin:'10px',width:'100%'}}>
<CssTextField name="someDate" label="เดือน/วัน/ปีเกิด" InputLabelProps={{ shrink: true, required: true }} type="date" fullWidth defaultValue={data.Birthday_Person} onChange={e => setBirthDay(e.target.value)}/>
</Box>
<Box sx={{margin:'10px',width:'100%'}}>
<CssTextField id="outlined-basic" fullWidth label="เบอร์โทรศัพท์" variant="outlined" defaultValue={data.Phone_Person} onChange={e => setNumberPhone(e.target.value)}/>
</Box>
<Grid container  columns={{ xs: 4, sm: 8, md: 12 }} sx={{margin:'10px'}}>
  ...
  <Box sx={{marginRight:{lg: '10px',
      ...
      sm: '10px',
      xs: '10px'}}}>
  <Link to="/PageMannage" style={{textDecoration: 'none'}}>
