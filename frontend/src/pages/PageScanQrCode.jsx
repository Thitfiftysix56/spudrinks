...
<Box
      ...
      <p>Scanned data: {result.text}</p>
            ...
            <Box>
            <Link to={from === '/PageSelectBeverage' ? '/PageSelectBeverage' : '/'} style={{textDecoration: 'none'}}><ColorButton sx={{color: '#ffffff'}} startIcon={<ArrowBackIcon />} variant="contained">BLACK</ColorButton> </Link>
            </Box>
        </Box>
</ThemeProvider>
    </>
